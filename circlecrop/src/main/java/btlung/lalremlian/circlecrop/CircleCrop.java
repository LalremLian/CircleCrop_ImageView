...
public class CircleCrop extends androidx.appcompat.widget.AppCompatImageView
{
    ...
    public CircleCrop(Context context, AttributeSet attrs, int defStyle)
    {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleCrop, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleCrop_cc_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleCrop_cc_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircleCrop_cc_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.CircleCrop_cc_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
